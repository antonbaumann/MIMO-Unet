...
ENV PYTHONPATH=$PYTHONPATH:/ws/dev/thomas/sen12tp/
ENV HOME=/ws
...
EXPOSE 20023
RUN mkdir /root/.ssh/
# RUN echo "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDrBOffopxAzSFUnKo9PTG9pXaD/5RHXJntllrguKTuy tom@tom-p14s" >> /root/.ssh/authorized_keys
